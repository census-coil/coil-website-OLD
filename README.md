...
1. Download, install, and start [Docker Community Edition](https://www.docker.com/community-edition). We have an organization called censuscoil on Docker - ask Kiran for invite info.
